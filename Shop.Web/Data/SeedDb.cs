namespace Shop.Web.Data
{
    ...
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            //}
            await this.CheckUserAsync("luisagudelo48@gmail.com", "luis", "lucho", "Customer");
            ...
            var user = await this.CheckUserAsync("andresdesarrollo1997@gmail.com", "Andres", "Yepes", "Admin");
            await this.CheckUserAsync("andreselbofo10@gmail.com", "Andres", "castañeda", "Admin");
        ...
        private void AddProduct(string name, decimal price, User user)
        {
            this.context.Products.Add(new Product
            {
                ...
                User = user,
                ImageUrl = $"~/images/Product/{name}.png"
            });
        }
    }
